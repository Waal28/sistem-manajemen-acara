...
export default function Footer() {
  ...
  const telepon = "+62 761 674674";
  const copyright = "Copyright © 2024. Wal Husna Faizul.";
  const socialMedias = [
    {
      name: "Facebook",
    ...
    {
      name: "Github",
      link: "https://www.instagram.com/uirois/",
      icon: (
        <svg
          className="w-4 h-4"
          aria-hidden="true"
              ...
              <ul className="text-gray-400 font-medium">
                {prodi.map((prodi) => (
                  <li className="mb-4" key={prodi.name}>
                    <Link href={prodi.link} className="hover:underline">
                      {prodi.name}
                    </Link>
                  </li>
                ))}
              ...
              <ul className="text-gray-400 font-medium">
                {layanan.map((layanan) => (
                  <li className="mb-4" key={layanan.name}>
                    <Link href={layanan.link} className="hover:underline">
                      {layanan.name}
                    </Link>
                  </li>
                ))}
